# ddpg_pendulum.py
# Rebuilt from your slides (Keras + TensorFlow + Gymnasium)
...
print("Action bounds:", lower_bound, "to", upper_bound)
...
# =========================================================
# Hyperparameters, models, optimizers
# =========================================================
std_dev  = 0.2
...
# =========================================================
# Training update (single gradient step)
# =========================================================
@tf.function
...
for ep in range(total_episodes):
    ...
    avg_reward = np.mean(ep_reward_list[-40:])  # last 40-episode moving average
...
plt.title("DDPG on Pendulum-v1 (Keras/TensorFlow)")
plt.show()
